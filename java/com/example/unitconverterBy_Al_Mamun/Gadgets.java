...
public class Gadgets {
    ...
    public String[] makeOneDArray(String[][] arr) {
    ...
    public String[] makeOneDArray(String[][] arr, int index) {
        String[] oneDArr = new String[arr.length];
        for (int i=0; i<arr.length; i++) {
            oneDArr[i] = arr[i][0];
        }
    ...
    public void openActivity(Context context, Class clas, String key, String value) {
        Intent i = new Intent(context, clas);
        i.putExtra(key, value);
        context.startActivity(i);
    }
    public void openActivity(Context context, Class clas) {
        Intent i = new Intent(context, clas);
        context.startActivity(i);
    }
    public void openActivity(Context context, String uri) {
        Uri u = Uri.parse(uri);
    ...
    public void takeInputs (View view, TextView inputTop, TextView inputBottom, Boolean inputIsTop, Context context) {
    ...
    public void  calculate(View view, String unitsAndValues[][], TextView inputTop, TextView inputBottom, boolean inputIsTop, String unit_1, String unit_2) {
    ...
    public void setResultText(boolean inputIsTop, TextView inputTop, TextView inputBottom, String text) {
        if (inputIsTop) {
    ...
    public boolean charAtString(String s, char c) {
        boolean bool = false;
    ...
    public String setComa (float finalResultFloat) {
    ...
    public String setComa (int finalResultFloat) {
        String text = String.valueOf(finalResultFloat);
        String newText = "";
        String text2 = text;
    ...
    public String setComa (String finalString) {
    ...
    public String removeComa (String text) {
        String newText = "";
        for (int i=text.length()-1; i >= 0; i--) {
            if (text.charAt(i) != ',') {
